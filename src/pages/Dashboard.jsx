    ...
    return (
        ...
        <div className="pb-12 lg:pl-[250px] md:pl-[60px] pl-[60px]">
            ...
            <div>
                ...
                I am a <span className="text-[#008073] font-bold">{"{ "}{skillsUpdate[currentSkillIndex]}{" }"}</span> <br></br> having 2+ years of experience
                </h1>
            </div>
            <div className="flex flex-col md:flex-row justify-between">
                <div className="flex flex-col">
                    ...
                    <div>
                        <p className="px-4 md:px-16 lg:px-20 text-[16px] md:text-[20px] md:font-bold py-5 pt-7 text-center md:text-start">With over 2+ years of experience in designing and <br/>building responsive web Sites.</p>
                    </div>
