            ...
            <div className="flex flex-col md:flex-row justify-between">
                ...
                <div>
                    ...
                    <div className="flex justify-between py-2 px-8 md:px-12 lg:px-20">
                        <div>
                            <p className="font-semibold md:font-bold text-[20] md:text-[24px] text-center">+4</p>
                            <p className="font-semibold text-[20px] md:text-[24px]">Web Sites</p>
                        </div>
                        <div>
                            <p className="font-semibold md:font-bold text-[20] md:text-[24px] text-center">+1</p>
